# vbrk.py : version 1.02 Date 2025-10-12
##################################################################################
...
def load_config(env_path: Path | None = None) -> dict:
    ...
    cfg = {
        ...
        "LANDING_URI": os.getenv("LANDING_URI", "s3a://landing/SAP/vbrk.csv"),
        "BRONZE_URI": os.getenv("BRONZE_URI", "s3a://bronze/sap/vbrk/"),
...
#######################################################################
# FKDAT - Billing Date in Document
# ERDAT - Creation Date
# FKDAT_RL - Billing Date in Document (Billing date when released to accounting
# KURRF_DAT - Exchange Rate Date --- IGNORE ---
#######################################################################
# --- Pure transform ---
