# vbup.py : version 1.01 Date 2025-10-12
##################################################################################
#    Item Status (SD Document item)
#    Shows overall status (delivery, billing, credit)
###################################################################################
#    ETL process for SAP vbup data from landing to bronze zone in parquet format.
...
def load_config(env_path: Path | None = None) -> dict:
    ...
    cfg = {
        ...
        "LANDING_URI": os.getenv("LANDING_URI", "s3a://landing/SAP/vbup.csv"),
        "BRONZE_URI": os.getenv("BRONZE_URI", "s3a://bronze/sap/vbup/"),
