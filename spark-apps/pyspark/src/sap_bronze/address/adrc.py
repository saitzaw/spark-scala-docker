#adrc.py : version 1.03 Date: 2025-10-12
#########################################################################################################
...
def load_config(env_path: Path | None = None) -> dict:
    ...
    cfg = {
        ...
        "LANDING_URI": os.getenv("LANDING_URI", "s3a://landing/SAP/adrc.csv"),
        "BRONZE_URI": os.getenv("BRONZE_URI", "s3a://bronze/sap/adrc/"),
