# kna1.py : version 1.01 Date 2025-10-05
##################################################################################
#    Customer Master – General Data (S&D and FI)
###################################################################################
#    ETL process for SAP kna1 data from landing to bronze zone in parquet format.
...
def load_config(env_path: Path | None = None) -> dict:
    ...
    cfg = {
        ...
        "LANDING_URI": os.getenv("LANDING_URI", "s3a://landing/SAP/kna1.csv"),
        "BRONZE_URI": os.getenv("BRONZE_URI", "s3a://bronze/sap/kna1/"),
