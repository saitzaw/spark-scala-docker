...
with DAG(
    dag_id='adhoc_crm_delta_veiw_job',
    ...
    submit_crm_job = SparkSubmitOperator(
        task_id='run_delta_single_view_crm',
        application='/opt/spark/jobs/scala/target/scala-2.12/deltasingleviewcrm_2.12-0.1.jar',
        conn_id='spark_default',  # or leave blank if not using Spark hook
        java_class='deltaSingleViewCRM',
        jars=db_jar,
        conf={
