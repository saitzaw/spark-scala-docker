...
## Alternative way to install Temurin OpenJDK 11 along with other dependencies
...
#       ca-certificates curl gnupg lsb-release netcat-traditional \
#     && rm -rf /var/lib/apt/lists/*

# Install Docker CLI (no daemon)
# RUN curl -fsSL https://get.docker.com -o /tmp/get-docker.sh \
#  && chmod +x /tmp/get-docker.sh \
#  && CHANNEL=stable sh /tmp/get-docker.sh --dry-run >/tmp/docker-install.sh \
